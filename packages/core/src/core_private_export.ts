...
export {ApplicationRootViews as ɵApplicationRootViews} from './application/application_root_views';
...
export {ChangeDetectionScheduler as ɵChangeDetectionScheduler} from './change_detection/scheduling';
