...
describe('change detection for transplanted views', () => {
  describe('when declaration appears before insertion', () => {
    ...
    describe('and declaration component is Signal and insertion is OnPush', () => {
      beforeEach(() => {
    ...
    describe('declaration is OnPush and insert is Signal', () => {
      beforeEach(() => {
      ...
      it('should CD at insertion point only', () => {
        ...
        expect(viewExecutionLog)
            .withContext(
                'Embedded views are created with `CheckAlways` even if they are defined in an OnPush component')
            .toEqual(['Insert']);
        expect(trim(fixture.nativeElement.textContent))
            .toEqual('OnPushDeclareComp(world) SignalInsertComp(Hello) templateGreeting Angular!');
        ...
        viewExecutionLog.length = 0;
        expect(trim(fixture.nativeElement.textContent))
            .toEqual('OnPushDeclareComp(world) SignalInsertComp(Hi) templateGreeting Angular!');
        ...
        expect(viewExecutionLog).toEqual([]);
        viewExecutionLog.length = 0;
        expect(trim(fixture.nativeElement.textContent)).toEqual('OnPushDeclareComp(world)');
