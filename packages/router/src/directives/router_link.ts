...
export class RouterLink implements OnChanges {
   ...
   * instantiation.
   */
  private maybeUpdateTabIndex(v: string|null) {
    if (this.tabIndex != null) {
      return;
    }
    if (v !== null) {
      this.renderer.setAttribute(this.el.nativeElement, 'tabindex', v);
    } else {
