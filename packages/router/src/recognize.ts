...
export class Recognizer {
  ...
  private expandSegmentAgainstRouteUsingRedirect(
    ...
    const i = getInherited(currentSnapshot, parentRoute, this.paramsInheritanceStrategy);
    currentSnapshot.params = Object.freeze(i.params);
    currentSnapshot.data = Object.freeze(i.data);
      ...
      switchMap((result) => {
        ...
        return this.getChildConfig(injector, route, segments).pipe(
          switchMap(({routes: childConfig}) => {
            ...
            const i = getInherited(snapshot, parentRoute, this.paramsInheritanceStrategy);
            snapshot.params = Object.freeze(i.params);
            snapshot.data = Object.freeze(i.data);
