  ...
  processSegmentAgainstRoute(
    ...
    if (route.path === '**') {
      ...
      snapshot = new ActivatedRouteSnapshot(
          ...
          getData(route), getOutlet(route), route.component ?? route._loadedComponent ?? null, route,
      ...
      snapshot = new ActivatedRouteSnapshot(
          ...
          this.urlTree.fragment, getData(route), getOutlet(route), route.component ?? route._loadedComponent ?? null, route,
          getSourceSegmentGroup(rawSegment), pathIndexShift, getResolve(route),
