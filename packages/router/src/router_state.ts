...
export class ActivatedRoute {
   ...
   * @experimental
   */
  public resources: {[key: string]: RouterResource<unknown, unknown>} | undefined;
  ...
  _commit(snapshot: ActivatedRouteSnapshot): void {
    ...
    if (!this.resources) {
      this.resources = snapshot.resourceResult;
    }
  }
  /** @internal */
  _rollback(): void {
...
export class ActivatedRouteSnapshot {
   ...
   * @internal
   */
  resourceResult?: {[key: string]: RouterResource<unknown, unknown>};
