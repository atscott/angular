...
import {withDomNavigation} from '../src/provide_router';
import {
  PlatformLocation,
  Location,
...
describe('withDomNavigation feature', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({providers: [provideRouter([], withDomNavigation())]});
  });
  ...
  it('throws an error if PlatformLocation is not FakeNavigationPlatformLocation', () => {
    TestBed.configureTestingModule({
      providers: [{provide: PlatformLocation, useClass: MockPlatformLocation}],
    });
    expect(() => TestBed.inject(PlatformNavigation)).toThrowError();
  });
